                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="single-service-item">
                            ...
                            <p>
                                We conduct our business with honesty, cooperation, transparency, and integrity, building trust and credibility
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="single-service-item">
                            ...
                            <p>
                                We believe in the power of collaboration and teamwork, working closely with our clients,
                                and employees to achieve mutual success and drive outcomes.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
            ...
            <div class="row">
                <div class="col-md-5 col-sm-12">
                    <div class="new-cars-txt">
                        <h2><a >Hardware and software solutions <span> </span></a></h2>
                        ...
                        <h5><a >Hardware Solutions <span> </span></a></h5>
                        <p style="color: #fff; text-align: justify; ">
                        ...
                        <h5><a >Software Solutions <span> </span></a></h5>
                        <p style="color: #fff; text-align: justify; ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-12">
                                    <div class="new-cars-txt">
                                        ...
                                        <p>
                                            Animations, explainer videos, and multimedia presentations to simplify ideas and engage viewers.
                                        </p>
                                    </div><!--/.new-cars-txt-->
                                </div><!--/.col-->
                            </div><!--/.row-->
                    ...
                    <div class="new-cars-item">
                        <div class="single-new-cars-item">
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-12">
                                    <div class="new-cars-txt">
                                        <h2><a href="#">Stationery <span></span></a></h2>
                                        <br>
                                        <h7 style="color: #067260af; font-weight: bold">Office Supplies</h7>
                                        <p>
                                            Pens, pencils, markers, paper, notebooks, planners, desk organizers, filing systems, and more.
                                        </p>

                                        <h7 style="color: #067260af; font-weight: bold">Packaging Design</h7>
                                        <p>
                                            Textbooks, backpacks, calculators, erasers, glue, and other essentials for all ages students.
                                        </p>

                                        <h7 style="color: #067260af; font-weight: bold">Bulk Ordering</h7>
                                        <p>
                                            Discounts and special pricing options available for bulk orders to accommodate the needs
                                        </p>
                                        <h7 style="color: #067260af; font-weight: bold">Customization & Delivery Services</h7>
                                        <p>
                                            Personalized stationery with Fast and reliable delivery nationalwide options to ensure timely receipt of orders.
                                        </p>
                                    </div><!--/.new-cars-txt-->
                                </div><!--/.col-->
                            </div><!--/.row-->
                            ...
                            <div class="testimonial-description">
                                <div class="testimonial-info">
                                    <div class="testimonial-img">
                                        <img src="assets/images/brand/ministries.png" alt="brand-image" />
                                    </div><!--/.testimonial-img-->
                                ...
                                <div class="testimonial-person">
                                    <h2><a>MINISTRY OF NATURAL RESOURCES</a></h2>
                                    <h4>AND TOURISM</h4>
                    ...
                    <div class="col-sm-3 col-xs-12">
                        <div class="single-testimonial-box">
                            <div class="testimonial-description">
                                ...
                                <div class="testimonial-person">
                                    <h2><a>National Microfinance Bank</a></h2>
                                    <h4>(plc)</h4>
                                </div><!--/.testimonial-person-->
                            </div><!--/.testimonial-description-->
                        </div><!--/.single-testimonial-box-->
                    ...
                    <div class="col-sm-3 col-xs-12">
                        <div class="single-testimonial-box">
                            <div class="testimonial-description">
                                ...
                                <div class="testimonial-person">
                                    <h2><a>Dar es salaa institute of Technology</a></h2>
                                    <h4>DIT</h4>
                                </div><!--/.testimonial-person-->
                            </div><!--/.testimonial-description-->
                        </div><!--/.single-testimonial-box-->
                    ...
                    <div class="col-sm-3 col-xs-12">
                        <div class="single-testimonial-box">
                            <div class="testimonial-description">
                                ...
                                <div class="testimonial-person">
                                    <h2><a>National Institute of Transportation</a></h2>
                                    <h4>(NIT)</h4>
                                </div><!--/.testimonial-person-->
                            </div><!--/.testimonial-description-->
                        </div><!--/.single-testimonial-box-->
                    ...
                    <div class="col-sm-3 col-xs-12">
                        <div class="single-testimonial-box">
                            <div class="testimonial-description">
                                ...
                                <div class="testimonial-person">
                                    <h2><a>Tanzania Ports Authority</a></h2>
                                    <h4>(TPA)</h4>
                                </div><!--/.testimonial-person-->
                            </div><!--/.testimonial-description-->
                        </div><!--/.single-testimonial-box-->
                    ...
                    <div class="col-sm-3 col-xs-12">
                        <div class="single-testimonial-box">
                            <div class="testimonial-description">
                                ...
                                <div class="testimonial-person">
                                    <h2><a>MINISTRY OF AGRICULTURE</a></h2>
                                    <h4>AND IRRIGATION</h4>
                                </div><!--/.testimonial-person-->
                            </div><!--/.testimonial-description-->
                        </div><!--/.single-testimonial-box-->
                    </div><!--/.col-->
                    <div class="col-sm-3 col-xs-12">
                        <div class="single-testimonial-box">
                            <div class="testimonial-description">
                                ...
                                <div class="testimonial-person">
                                    <h2><a>National Bureau of Statistics</a></h2>
                                    <h4>(NBS)</h4>
                                </div><!--/.testimonial-person-->
                            </div><!--/.testimonial-description-->
                        </div><!--/.single-testimonial-box-->
